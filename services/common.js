...
let transporter = nodemailer.createTransport({
  ...
  auth: {
    user: 'gautamsudhanshu2911@gmail.com', // gmail
...
//  When you use the async keyword before a function, it means that the function will return a Promise (in invoice template we cant use async)
...
exports.invoiceTemplate = function(order){
 ...
 <body style="background-color: #D2C7BA;">
   ...
   <div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
    Thank you for your order! Check out your order receipt and stay tuned for exciting updates.
   </div>
   <!-- end preheader -->
         ...
         <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
           <tr>
             <td align="center" valign="top" style="padding: 36px 24px;">
               <a href="https://simple-mart-ecommerce.onrender.com" target="_blank" style="display: inline-block;">
               <img src="https://i.postimg.cc/JnHHy8y7/Screenshot-2023-12-13-200146.png" alt="Logo" border="0" width="80" style="display: block; width: 80ox; max-width: 80px; min-width: 48px;">
               </a>
             </td>
           </tr>
         </table>
                 ...
                 <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 300px;">
                   <tr>
                     <td align="left" valign="top" style="padding-bottom: 36px; padding-left: 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                       ...
                       <p>${order.selectedAddresses.name}<br>${order.selectedAddresses.street}<br>${order.selectedAddresses.city},${order.selectedAddresses.state},${order.selectedAddresses.pinCode}</p>
